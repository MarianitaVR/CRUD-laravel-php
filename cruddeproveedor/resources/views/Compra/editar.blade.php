                          ...
                          <div class="d-flex flex-wrap gap-5">
                            ...
                            <div class="row">
                              ...
                              <div class="col-3 mb-2 text-white">
                                ...
                                <input type="button" onclick="agregar_producto(<?php echo isset($compra->idCompra) ? $compra->idCompra : 0 ?>)" id="agregarbtn" name="" value="Agregar" class="form-control btn btn-success">
                              </div>
                              <div class="row">
                                <div class="col-12 mb-2">
                                  ...
                                  <table class="table table-striped table-hover table-bordered" id="tablaP{{isset($compra->idCompra)?$compra->idCompra:0}}">
                                    ...
                                    <tbody id="tablaProductos{{isset($compra->idCompra)?$compra->idCompra:0}}">
