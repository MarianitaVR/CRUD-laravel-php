                                                ...
                                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                                    <div class="mb-4 px-9">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <span
                                                                class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">47,769,700</span>
                                                            <span
                                                                class="d-flex align-items-end text-gray-400 fs-6 fw-bold">Tons</span>
                                                        </div>
                                                ...
                                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                                    ...
                                                    <div class="mb-4 px-9">
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            <!--begin::Value-->
                                                            <span
                                                                class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">259,786</span>
                                                            <!--end::Value-->
                                                            <!--begin::Label-->
                                                            <!--end::Label-->
                                                        </div>
                                            ...
                                            <ul class="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9">
                                                ...
                                                <li class="nav-item col-4 mx-0 p-0">
                                                    ...
                                                    <a class="nav-link active d-flex justify-content-center w-100 border-0 h-100"
                                                        ...
                                                        <!--begin::Subtitle-->
                                                        <span
                                                            class="nav-text text-gray-800 fw-bolder fs-6 mb-3">Notable</span>
                                                        <!--end::Subtitle-->
                                                        <!--begin::Bullet-->
                                                        <span
                                                ...
                                                <li class="nav-item col-4 mx-0 px-0">
                                                    ...
                                                    <a class="nav-link d-flex justify-content-center w-100 border-0 h-100"
                                                        ...
                                                        <!--begin::Subtitle-->
                                                        <span
                                                            class="nav-text text-gray-800 fw-bolder fs-6 mb-3">Delivered</span>
                                                        <!--end::Subtitle-->
                                                        <!--begin::Bullet-->
                                                        <span
                                                            class="bullet-custom position-absolute z-index-2 bottom-0 w-100 h-4px bg-primary rounded"></span>
                                                ...
                                                <li class="nav-item col-4 mx-0 px-0">
                                                    ...
                                                    <a class="nav-link d-flex justify-content-center w-100 border-0 h-100"
                                                        ...
                                                        <!--begin::Subtitle-->
                                                        <span
                                                            class="nav-text text-gray-800 fw-bolder fs-6 mb-3">Shipping</span>
                                                        <!--end::Subtitle-->
                                                        <!--begin::Bullet-->
                                                        <span
                                                            class="bullet-custom position-absolute z-index-2 bottom-0 w-100 h-4px bg-primary rounded"></span>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex-grow-1 me-2">
                                                                    <a href="#" class="text-gray-400 fs-6 fw-bold">Ship
                                                                        Freight</a>
                                                                    <span
                                                                        class="text-gray-800 fw-bolder d-block fs-4">#5635-342808</span>
                                                                </div>
                                                                <span
                                                        ...
                                                        <div class="timeline">
                                                            ...
                                                            <div class="timeline-item align-items-center mb-7">
                                                                ...
                                                                <div class="timeline-content m-0">
                                                                    <!--begin::Title-->
                                                                    <span
                                                                        class="fs-6 text-gray-400 fw-bold d-block">Messina
                                                                        Harbor</span>
                                                                    <!--end::Title-->
                                                                    <!--begin::Title-->
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex-grow-1 me-2">
                                                                    <a href="#" class="text-gray-400 fs-6 fw-bold">Truck
                                                                        Freight</a>
                                                                    <span
                                                                        class="text-gray-800 fw-bolder d-block fs-4">#0066-954784</span>
                                                                </div>
                                                                <span
                                                        ...
                                                        <div class="timeline">
                                                            ...
                                                            <div class="timeline-item align-items-center">
                                                                ...
                                                                <div class="timeline-content m-0">
                                                                    <!--begin::Title-->
                                                                    <span
                                                                        class="fs-6 text-gray-400 fw-bold d-block">Forest-Midi</span>
                                                                    <!--end::Title-->
                                                                    <!--begin::Title-->
                                                        ...
                                                        <div class="timeline">
                                                            ...
                                                            <div class="timeline-item align-items-center">
                                                                ...
                                                                <div class="timeline-content m-0">
                                                                    <!--begin::Title-->
                                                                    <span
                                                                        class="fs-6 text-gray-400 fw-bold d-block">Singapore
                                                                        Cargo</span>
                                                                    <!--end::Title-->
                                                                    <!--begin::Title-->
                                                    ...
                                                    <ul class="nav nav-pills nav-pills-custom mb-3">
                                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                                            <a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active"
                                                                ...
                                                                <span
                                                                    class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Ship</span>
                                                                <span
                                                        ...
                                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                                            <a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                                ...
                                                                <span
                                                                    class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Truck</span>
                                                                <span
                                                                    class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                                            <a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                                ...
                                                                <span
                                                                    class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Plane</span>
                                                                <span
                                                                    class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                                            <a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                                ...
                                                                <span
                                                                    class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Train</span>
                                                                <span
                                                                    class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                            </a>
                                                        </li>
